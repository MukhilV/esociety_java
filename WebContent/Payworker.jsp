...
ResultSet rs1=stmt1.executeQuery("select mailid,name from workers");
while(rs1.next()){
	workerid[ptr]=rs1.getString(1);
	workername[ptr++]=rs1.getString(2);	
}
  ...
  <div class="card" >
    ...
    <div class="card-body" style="font-size:15px;">
       ...
       <!-- <input type="text" name="eventname" style="height: 70px; width: 100%" placeholder=" Event name" required>-->
        ...
        <select name="workerid"  style="height:70px; width: 100%" required>
				<option value="" selected disabled >Worker Mail id</option>
				<% for(int i=0;i<ptr;i++){
					out.println("<option value=\""+workerid[i]+"\" >"+workerid[i]+" ("+workername[i]+")</option>");
				}
				%>
 			</select>
