...
<div class="pay" style="margin: 0 auto;" >
        ...
        <form action="WithdrawServ" method="post">
          ...
          <!--  <br><input type="number" name="fine" style="height: 40px; width: 100%" placeholder=" Enter fine" required><br> 
           
           <br><input type="submit" value="Withdraw" style="height: 70px; width: 100%;" class="button"><br>
...
<h1 style="text-align:center"><b>Withdraw section</b></h1>
<br>
 <div class="container" style="width:40%;margin:0 auto;">
  <div class="card" >
        <form action="WithdrawServ" method="post">
        
    <div class="card-header" style='background-color:#397993;color:white;'>Withdraw money for events</div>
    ...
    <!-- 	<input type="text" name="eventname" style="height: 70px; width: 100%" placeholder=" Event name" required> -->
     ...
     <select name="eventname"  style="height:70px; width: 100%" required>
           ...
           <input type="submit" value="Withdraw" style="height: 70px; width: 100%;" class="btn btn-info"><br>
     </div> 
...
String deletionstatus=(String)request.getAttribute("deletionstatus");
if(deletionstatus!=null){
	out.println("<div class=\"alert alert-dark\">"+deletionstatus+"</div>");
}
%>
